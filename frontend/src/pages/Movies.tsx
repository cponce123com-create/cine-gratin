  ...
  return (
    <div className="min-h-screen bg-brand-dark pt-20 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-black text-white mb-2">Peliculas</h1>
          <p className="text-gray-400 text-sm">
            {movies ? `${filtered.length} de ${movies.length} peliculas` : "Cargando..."}
          </p>
        </div>
        ...
        {error && (
          <div className="text-center py-20">
            <p className="text-red-400 text-lg">No se pudo cargar las peliculas.</p>
        ...
        {!loading && !error && filtered.length === 0 && (
          <div className="text-center py-20">
            <p className="text-gray-400 text-lg">No hay peliculas que coincidan.</p>
            <button
